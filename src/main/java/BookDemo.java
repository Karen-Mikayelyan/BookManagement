...
public class BookDemo implements Commands {
    ...
    public static void initData() {
        ...
        bookStorage.add(new Book("India After Gandhi", ramchandraguha, 5000, 3, "historical", admin));
        bookStorage.add(new Book("Triumphal Arch", erichmariaremarque, 8000, 5, "prose", admin));
        bookStorage.add(new Book("Don Juan", georgebyron, 10000, 7, "satire", admin));
    }
    ...
    private static void addAuthor() {
        ...
        Author author = new Author(authorName, authorSurname, email, Gender.valueOf(gender));
